<template>
            ...
            <li class="product-item">
                ...
                <div class="product-info">
                    ...
                    <button @click="addToCart(product)" class="add-to-cart-btn">
                        <img src="/src/assets/Imagenes/iCarrito.png" class="button-icon" alt="Carrito">
                        Agregar al carrito
                    </button>
                </div>
            </li>
    ...
    <div class="cart-section">
            ...
            <li class="cart-item">
                ...
                <div class="cart-info">
                    ...
                    <button @click="removeFromCart(item)" class="remove-from-cart-btn">
                        <img src="/src/assets/Imagenes/iBasura.png" class="button-icon" alt="Basurero">
                        Remover del carrito
                    </button>
                </div>
            </li>
        ...
        <button v-if="cart.length > 0" @click="removeAllCart" class="remove-from-cart-btn">
            <img src="/src/assets/Imagenes/iTodaBasura.png" class="button-iconBasuraTotal" alt="CamionBasurero">
            Vaciar carrito
        </button>
