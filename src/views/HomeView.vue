<template>
    ...
    <div class="products-section">
        ...
        <ul v-for="product in products" :key="product.id">
            <li class="product-item">
                <img :src="`Imagenes/product-${product.id}-${product.name.replace(' ', '-')}.webp`" alt="Imagen del producto" />
                ...
                <div class="product-info">
                    ...
                    <button @click="addToCart(product)" class="add-to-cart-btn">
                        <img src="Imagenes/iCarrito.png" class="button-icon" alt="Carrito">
                        Agregar al carrito
                    </button>
                </div>
            </li>
    ...
    <div class="cart-section">
        ...
        <ul v-for="item in cart" :key="item.product.id">
            <li class="cart-item">
                <img :src="`Imagenes/product-${item.product.id}-${item.product.name.replace(' ', '-')}.webp`" alt="Imagen del producto" />
                ...
                <div class="cart-info">
                    ...
                    <button @click="removeFromCart(item)" class="remove-from-cart-btn">
                        <img src="Imagenes/iBasura.png" class="button-icon" alt="Basurero">
                        Remover del carrito
                    </button>
                </div>
            </li>
        ...
        <button v-if="cart.length > 0" @click="removeAllCart" class="remove-from-cart-btn">
            <img src="Imagenes/iTodaBasura.png" class="button-iconBasuraTotal" alt="CamionBasurero">
            Vaciar carrito
        </button>
